...
class Settings:
    ...
    # refund policy - the exact tiers/cutoffs the task leaves
    # unspecified, flagged clearly here as our own reasonable defaults
    # rather than buried inside the service logic
    REFUND_FULL_REFUND_DAYS_BEFORE: int = int(os.getenv("REFUND_FULL_REFUND_DAYS_BEFORE", 7))
    REFUND_PARTIAL_REFUND_PERCENTAGE: float = float(os.getenv("REFUND_PARTIAL_REFUND_PERCENTAGE", 0.50))

...
# used for event organizer and staff - the 2 roles with no extra fields
# beyond the base login account. speaker and attendee both have their
# own dedicated create schemas instead, same reasoning as every
# previous project's profile-bearing roles

...
# admin creates event organizer; event organizer creates staff. speaker
# and attendee both go through their own dedicated schemas/endpoints
# instead, never through this generic path
def _allowed_roles_for(current_user_role: UserRole) -> list:
    ...
    if current_user_role == UserRole.EVENT_ORGANIZER:
